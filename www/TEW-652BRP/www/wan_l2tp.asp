...
<SCRIPT LANGUAGE="JavaScript">
	function loadSettings(){
		...
		disable_static_address(get_by_name("wan_l2tp_dynamic"), get_by_id("wan_l2tp_ipaddr"), get_by_id("wan_l2tp_netmask"), get_by_id("wan_l2tp_gateway"));
		check_connectmode();
	}
	...
	function send_request(){
		...
		if (get_by_id("wan_l2tp_server_ip").value == ""){
			alert("Server IP can't be blank");
			return false;
		}
              ...
              <td height="400" background="bg3.gif">
                  ...
                  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
                    <tr>
                      ...
                      <br>
                      <input type="radio" value="1" name="wan_l2tp_dynamic" onClick='disable_static_address(get_by_name("wan_l2tp_dynamic"), get_by_id("wan_l2tp_ipaddr"), get_by_id("wan_l2tp_netmask"), get_by_id("wan_l2tp_gateway"))'><b>Dynamic IP</b>&nbsp;&nbsp;&nbsp; 
                      <input type="radio" value="0" name="wan_l2tp_dynamic" onClick='disable_static_address(get_by_name("wan_l2tp_dynamic"), get_by_id("wan_l2tp_ipaddr"), get_by_id("wan_l2tp_netmask"), get_by_id("wan_l2tp_gateway"))'><b>Static IP</b></td>
                    </tr>
                  </table>
                  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
