...
<SCRIPT LANGUAGE="JavaScript">
	...
	function send_request(){
		...
		if (user_name == ""){
	     ...
	     if (get_by_id("wan_pptp_password").value == "" || get_by_id("pwd2").value == ""){
                   ...
                   <table width="100%" height="301" border="0" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF">
                    ...
                    <tr>
                      ...
                      <td bgcolor="#FFFFFF" class="bggrey">
										  ...
										  <input type="hidden" id="support_pptp_mppe" name="support_pptp_mppe" value="<% CmoGetCfg("support_pptp_mppe","none"); %>"></td> 
  						      </tr>
										<tr>
                       <td align="right" class="bgblue">&nbsp;</td>
                       <td bgcolor="#FFFFFF" class="bggrey2">
                       	<input type="button" id="cancel" name="cancel" value="Cancel" onClick="window.location='wan_russia_pptp.asp'">
