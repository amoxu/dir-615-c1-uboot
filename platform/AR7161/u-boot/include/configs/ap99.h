...
#ifndef LP_SUPPORT
#define TEMP_BOOTARGS "console=ttyS0,115200 root=31:03 rootfstype=squashfs,jffs2 init=/sbin/init mtdparts=ar7240-nor0:"MTD_LOADER_LENGTH"k(u-boot),64k(nvram),"MTD_KERNEL_LENGTH"k(linux),"MTD_ROOTFS_LENGTH"k(rootfs),"MTD_MAC_LENGTH"k(MAC),"MTD_ART_LENGTH"k(ART)"
#else
#define TEMP_BOOTARGS "console=ttyS0,115200 root=31:03 rootfstype=squashfs,jffs2 init=/sbin/init mtdparts=ar7240-nor0:"MTD_LOADER_LENGTH"k(u-boot),64k(nvram),"MTD_KERNEL_LENGTH"k(linux),"MTD_ROOTFS_LENGTH"k(rootfs),"MTD_MAC_LENGTH"k(MAC),"MTD_LP_LENGTH"k(LP),"MTD_ART_LENGTH"k(ART)"
#endif
...
/* Flash Bank support, flash must is 8M */
#ifdef BACK_BANK_SUPPORT 
#define CFG_FLASH_SIZE		0x00800000  /* Total flash is 8M */
#else
#define CFG_FLASH_SIZE          0x00400000 /* Total flash is 4M */
#endif
...
#define	CONFIG_BOOTARGS    TEMP_BOOTARGS
...
#define CONFIG_BOOTCOMMAND "bootm 0xbf040000"
...
#define CONFIG_COMMANDS (( CONFIG_CMD_DFL | CFG_CMD_ENV | CFG_CMD_FLASH | CFG_CMD_RUN | CFG_CMD_MII | CFG_CMD_ETHREG ))
...
#ifdef BACK_BANK_SUPPORT
/* 8M flash WLAN Calibration 0xbf421000 and 0xbf420000 */
#define WLANCAL                         0xbf421000
#define MACADDR                         0xbf410000
#else
/* 4M flash WLAN Calibration 0xbf3f1000 and 0xbf3f0000 */
/* 0xbfff1000 == 0xbf3f1000. */
/* MACADDR is saving mac address */
#define WLANCAL                         0xbfff1000
#define MACADDR	                        0xbf3b0000
#endif
