...
#ifdef SET_MACBLOCK
#define	CONFIG_BOOTARGS     "console=ttyS0,115200 root=31:03 rootfstype=squashfs,jffs2 init=/sbin/init mtdparts=ar7100-nor0:128k(u-boot),64k(Config),1024k(vmlinux),2688k(rootfs),64k(MAC),128k(ART)"
#else	//SET_MACBLOCK
/* XXX - putting rootfs in last partition results in jffs errors */
#define	CONFIG_BOOTARGS     "console=ttyS0,115200 root=31:03 rootfstype=squashfs,jffs2 init=/sbin/init mtdparts=ar7100-nor0:128k(u-boot),64k(Config),1024k(vmlinux),2752k(rootfs),128k(ART)"
#endif
...
#define MTDPARTS_DEFAULT    "mtdparts=ar7100-nor0:256k(u-boot),64k(Config),1024k(uImage),2048(squashfs)"
...
#elif (CFG_PLL_FREQ == CFG_PLL_400_400_200) || (CFG_PLL_FREQ == CFG_PLL_360_360_180) || (CFG_PLL_FREQ == CFG_PLL_400_400_100)
