...
#endif
#ifdef AP99
		//Only listen LAN eth no matter WAN has cable pluged or not in backup mode.
		//Notice: LAN eth is hard code-->eth1,please modify it by your platform
		if (eth_current->init(eth_current, bis) && strcmp(eth_current->name,"eth1") == 0) {
#else
