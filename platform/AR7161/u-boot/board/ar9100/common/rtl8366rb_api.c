...
* $Id: rtl8366rb_api.c,v 1.1.1.1 2010/05/26 14:45:46 NickChou Exp $
*/
/*	@doc rtl8366rb_api
...
int32 rtl8366rb_initChip(void)
{
	...
	uint32 verid;
	DEBUG_MSG("rtl8366s_initChip enter\n");
...
DEBUG_MSG("rtl8366s_initChip finished\n");
	return SUCCESS;
}
...
{
	DEBUG_MSG("rtl8366rb_setMac5ForceLink enter \n");
	...
	DEBUG_MSG("rtl8366rb_setMac5ForceLink finished\n");
	return SUCCESS;
}

int32 rtl8366_setMac5ForceLink(enum PORTLINKSPEED speed,enum PORTLINKDUPLEXMODE duplex, uint32 link, uint32 txPause, uint32 rxPause)
{
	rtl8366rb_macConfig_t mac5_cfg;
	
	mac5_cfg.force = MAC_FORCE;
	mac5_cfg.speed = speed;
	mac5_cfg.duplex = duplex;
	mac5_cfg.link = link;
	mac5_cfg.txPause = txPause;
	mac5_cfg.rxPause = rxPause;
