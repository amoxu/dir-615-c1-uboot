...
LZMA=$TOOL_PATH/../tools/lzma/sdk4.17/lzma

mkdir -p $IMG_PATH

cp $KERNELPATH/vmlinux $IMG_PATH
...
#  L7_BS=655350
  ...
  if [ $1 == "ap51" -o $1 == "ap51-debug" -o $1 == "ap48" -o $1 == "ap48-debug" -o $1 == "ap43" -o $1 == "ap43-debug" -o $1 == "ap61" -o $1 == "ap61-debug" ]; then
    LENGTH=0x70000
