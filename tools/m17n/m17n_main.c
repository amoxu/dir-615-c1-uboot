...
void help_info(void)
{
	...
	printf("  	-l language	Select a language to create,only support TW,JA,GE,GR,KR and EN now.Default is EN.\n");
		...
		switch (ret) 
		{
			...
			case 'l':
				...
				if(strcmp(optarg,"TW") != 0 && strcmp(optarg,"JA") != 0 && strcmp(optarg,"EN") != 0 &&
				   strcmp(optarg,"DE") != 0 && strcmp(optarg,"ES") != 0 && strcmp(optarg,"KR") != 0 &&
				   strcmp(optarg,"CN") != 0 && strcmp(optarg,"FR") != 0 && strcmp(optarg,"IT") != 0)
				{
					printf("Not supported language.Only support TW, CN, JA, EN, DE, ES, FR, IT and KR.\n");
					return -1;
				}
				else
				{
